...
public class FactoryHeroica implements AbstracFactoryRazas{
    ...
    public void setEdificioPrincipal(){
        ...
        edificioPrincipal.EdificioP("Bunquer","Granito","Ether","Carbono", 
    ...
    public void setEdificioTropa(String guarnicio){
        ...
        TropasHeroicas tropa = new TropasHeroicas();
        
        switch(guarnicio)
        {
            case "gremio":
                tropa.TropasHeroicas("Incursion", 100, 35, 25, 10, 10, 5,0);
                edificioTropas.EdificioT("Guarnicion de Incursion", tropa, 150, 75, 75, 75, 2, this.fase,4);
                break;
            case "magos":
                tropa.TropasHeroicas("Reclutas", 10, 7, 6, 5, 5, 0,0);
                edificioTropas.EdificioT("Guarnicion de Reclutas", tropa, 100, 50, 50, 50, 5, this.fase,4);
                break;
            case "especial":
                tropa.TropasHeroicas("Inquisidor", 100, 50, 50, 0, 50, 50,0);
    ...
    public void setEdificioVehiculo(String taller){
        ...
        VehiculosHeroicos vehiculo = new VehiculosHeroicos();
        
        switch (taller)
        {
            case "aerodeslizador":
                vehiculo.VehiculosHeroicos("Demoledor", 100, 30, 0, 25, 25,0);
                edificioVehiculo.EdificioV("Taller de Demoledor", vehiculo, 100, 100, 100, 100, 1, this.fase, 4);
                break;
            case "espejo de fuego":
                vehiculo.VehiculosHeroicos("Helicoptero", 100, 30, 0, 25, 25,0);
                    ...
                    switch(menuCreacionista.menuTropas())
                    {
                        case "Incursion":
                            if (listaEdificioGuarnicion.isEmpty())
                            {
                                ...
                                {
                                    TropasHeroicas tropaAux = listaEdificioGuarnicion.get(index-1).getTropa();
                    ...
                    switch(menuCreacionista.menuVehiculos()){
                        case "Demoledor":
                            ...
                            break;
                                ...
                                {
                                    VehiculosHeroicos vehiculoAux = listaEdificioTalleres.get(index-1).getVehiculo();
                                    System.out.println("Cantidad a adiestrar (max 5):");
                                    int cantidad = entrada.nextInt();
